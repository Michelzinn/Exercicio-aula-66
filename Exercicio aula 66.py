...
def primeiro_duplicado(param_lista_de_inteiros):
    set_de_numeros_checados = set()
    numero_duplicado = -1  # precisa retornar -1 se n tiver numero duplicado

    for numero in param_lista_de_inteiros:

        if numero in set_de_numeros_checados:
            numero_duplicado = numero
            break

        set_de_numeros_checados.add(numero)
    return numero_duplicado


for lista_de_inteiro in lista_de_listas_de_inteiros:
    print(lista_de_inteiro, primeiro_duplicado(lista_de_inteiro))
